            ...
            <div className="flex flex-row justify-between">
                <div className="flex flex-row gap-3 items-center">
                    ...
                    <div className="flex flex-col items-start">
                        <h1 className="text-stone-700 font-semibold text-md inline-block">Malthe Hartmann</h1>
                        <span className="text-stone-500 font-medium leading-none text-md">Designer</span>
                    </div>
                </div>
