    ...
    return (
        <div className="relative w-[100%]">
            <div className="relative h-[100vh] overflow-hidden">
                ...
                <img src="/programming/3.9f3b94.webp" alt="" className="z-20 absolute object-contain bottom-10 sm:md-bottom-10 md:bottom-20 transition-all duration-700 scale-110" />
                ...
                <img src="/programming/2.f285ca.webp" alt="" className="z-40 absolute object-contain -bottom-0 sm:md-bottom-0 md:-bottom-0 transition-all duration-700 scale-150" />
