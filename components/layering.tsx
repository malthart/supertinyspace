    ...
    return (
        <div className="relative w-[100%]">
            <div className="relative h-[90vh] sm:h-[100vh] overflow-hidden transition-all duration-1000">
                ...
                <img src="/programming/3.9f3b94.webp" alt="" className="z-20 absolute object-contain bottom-20 sm:bottom-20 transition-all duration-1000 scale-110 sm:scale-100 lg:scale-100" />
